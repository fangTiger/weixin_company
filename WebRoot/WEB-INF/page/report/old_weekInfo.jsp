...
<link rel="stylesheet" href="/css/old_main.css" type="text/css"></link>
<link rel="stylesheet" href="/css/old_list.css" type="text/css"></link>
...
.hmBox p.bl3 {
    border-left: 0.4em solid #2779B5;
}
.hmBox p {
    padding: 0px 1em;
...
<script type="text/javascript" src="/js/page/report/old_weekInfo.js" charset="utf-8"></script>
</head>
<body>
	<div id="tell"></div>
	...
	<div id="hmBox" class="hmBox" style="font-size: 1.0em"></div>
