...
<script type="text/javascript" src="/js/page/report/inewsReportList.js" charset="utf-8"></script>
</head>
<body>
	...
	<div class="container">
	    ...
	    <!-- 列表内容start -->
	    <div id="titleDiv" class="weui_cells_title"><p><span>${weekName}&nbsp;</span></p></div>
