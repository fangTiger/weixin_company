...
<html>
  <head>
	...
	<script type="text/javascript" src="js/page/warning/warningLevels.js"></script>
  ...
  <body>
    ...
    <div class="container">
	    ...
	    <div class="weui_cells_title" id="warning_title"><p><span>预警级别列表</span></p></div>
	     <!-- 列表内容start -->
	    <div class="weui_cells weui_cells_access" id="hmList"></div>
	     <!-- 列表内容end -->
		...
		<div class="weui_dialog_alert" id="dialog" style="display: none;">
		    ...
		    <div class="weui_dialog">
		        <div class="weui_dialog_hd"><strong class="weui_dialog_title">Sorry！</strong></div>
		        <div class="weui_dialog_bd">当前预警级别下，暂未有预警信息</div>
		        <div class="weui_dialog_ft">
		            <a href="javascript:hideDialog();" class="weui_btn_dialog primary">确定</a>
		        </div>
		    </div>
		</div>
   </div>
